...
var doc = new GoogleSpreadsheet('d/1whcNDnxf59M_ZGgG85hyZfaLtce3Ip2hzLppMHxnKYU');
...
setInterval(function() {
    ...
    if (gogo == true && gogoFour < 45 && bv > 3000 && gogobuy) {
    ...
    if (gogo == true && gogoFour < 45 && av > 3000 && gogosell) {
        if (avail / btcNow < 0.75) {
            tar = tar + btcNow * 400
        }
        gogoFour++;
