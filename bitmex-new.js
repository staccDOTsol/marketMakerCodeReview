...
const client = new BitMEXClient({
  ...
  apiKeyID: 'SjIwnOuS3TH-KC-qb9IDox_H',
  apiKeySecret: 'JOPfxG_-VGkMuz0JwhFAMm23euF73gGy2p-wtxOZ_HmlX_hV',
  maxTableLen: 10000  // the maximum number of table elements to keep in memory (FIFO queue)
});

var ccxt = require("ccxt");
let bitmex  = new ccxt.bitmex ({ 'enableRateLimit': true, apiKey: "SjIwnOuS3TH-KC-qb9IDox_H", secret: "JOPfxG_-VGkMuz0JwhFAMm23euF73gGy2p-wtxOZ_HmlX_hV" })
...
var doc = new GoogleSpreadsheet('1WABO9YomDfgvDijKxrnGlFLGvWADf9kQOyerVgNVsKI');
